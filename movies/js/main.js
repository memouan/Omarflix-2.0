...
function getMovie() {
    ...
    axios.get(`https://api.themoviedb.org/3/movie/${movieId}?api_key=5ec279387e9aa9488ef4d00b22acc451`)
        .then((response) => {
            ...
            <div class="row">
            <div class="trailer">
            <iframe src="https://www.imdb.com/video/imdb/${movieId}/imdb/embed?autoplay=false" frameborder="0" width="560" height="315" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
            </div>
            <div class="row">
