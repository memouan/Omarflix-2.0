...
<body>
        ...
        <div class="container">
            <div class="sbox">
                ...
                <div>
                    <center>
                        <div class="content">
                            <h1 style="color: white">OmarFlix: Information about over 10k+ movies</h1>
                            <p style="color: white">
                                Welcome to
                                <span style="font-weight:bold; color: #E50914">OmarFlix</span> | It is site where you can view information about your favourite movie.
                                OmarFlix are best known for the excellent
                                <span style="font-weight:bold; color: #E50914">Information</span> for each and every released and not released movies. We are providing
    ...
    <script src="../js/logoOnClick.js"></script>
    <script>
        popularMovies();
    </script>
</body>
