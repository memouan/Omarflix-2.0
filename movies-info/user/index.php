            ...
            <center>
                <div class=" inner-body ">
                    <h1 class="title ">Welcome,
                        <span style="color: #E50914; text-transform:lowercase;"><?php echo $_SESSION['username'] ?></span>
                    </h1>
                    <p style="color: white" class="content">
                        Welcome to
                        <span style="font-weight:bold; color: #E50914">OmarFlix</span> | It is site where you can view information about your favourite movie. MoviesInfo
